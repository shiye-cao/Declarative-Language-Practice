...
const ModelConfig: React.FC<ModelConfigProps> = ({
  ...
  return (
    <div className="max-w-3xl mx-auto">
      ...
      <textarea
        className="w-full h-70 p-4 border border-gray-300 rounded font-mono overflow-auto whitespace-pre-wrap text-left text-xs"
        value={currentPrompt}
        onChange={(e) => setCurrentPrompt(e.target.value)}
        placeholder="Write the prompt for the conversational robot here."
      />
